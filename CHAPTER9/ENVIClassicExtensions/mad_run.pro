...
PRO mad_run_define_buttons, buttonInfo
 ...
 ;     EVENT_PRO = 'mad_run', $
      ...
      /menu
   ENVI_DEFINE_MENU_BUTTON, buttonInfo, $
      VALUE = 'Compute new stats and run iMAD', $
      REF_VALUE = 'iMAD', $
      EVENT_PRO = 'mad_run', $
      UVALUE = 'iMAD',$
      POSITION = 'after' 
   ENVI_DEFINE_MENU_BUTTON, buttonInfo, $
      VALUE = 'Run iMAD from existing stats', $
      REF_VALUE = 'iMAD', $
      EVENT_PRO = 'mad_run_stats', $
      UVALUE = 'iMAD',$
      POSITION = 'after'    
END
...
if mad_iter(fid1, fid2, dims1, dims2, pos1, pos2, m_fid, niter=niter, rho=rho, $
       sigma=sigma, A=A, B=B, lam=lam, means1=means1, means2=means2,/verbose) ne 0 $
