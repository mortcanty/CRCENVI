...
pro radcal_run5_extensions_init
   compile_opt idl2
   e = envi(/current)
   e.addextension, 'Radiometric Normalization', 'radcal_run5', path = 'Chapter9'
end

;+
; :Description:
;     Radiometric normalization using IR-MAD::
...
envi_convert_file_coordinates, fid2, dims2[1], dims2[3], ee, n, /to_map
map_info2.mc= [0D,0D,ee,n]
