...
pro fkm_run5_extensions_init
   compile_opt idl2
   e = envi(/current)
   e.addextension, 'Fuzzy K-Means Clustering', 'fkm_run5', path='Chapter8'
end
...
envi_convert_file_coordinates, fid, dims[1], dims[3], ee, n, /to_map
map_info.mc[2:3]= [ee,n]
