...
PRO dwt_run_define_buttons, buttonInfo
   ENVI_DEFINE_MENU_BUTTON, buttonInfo, $
      VALUE = 'Discrete Wavelet Transform', $
...
COMPILE_OPT STRICTARR
   ...
   print, '---------------------------------'
   print, 'ARSIS DWT Model for Wavelet Fusion'
   print, systime(0)
   print, '---------------------------------'
...
; get output destination
   ...
   query=dialog_message('Use subpixel shift?',/question)
   if query eq 'Yes' then sp_flag=1 else sp_flag=0
