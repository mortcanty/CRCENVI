...
pro c_correction_run5_extensions_init
   compile_opt idl2
   e5 = envi(/current)
   e5.addextension, 'C-Correction', 'c_correction_run5', path='Chapter5'
end
...
envi_convert_file_coordinates, fid_image, dims_image[1], dims_image[3], ee, n, /to_map
...
envi_convert_file_coordinates, fid_dem, X_ul, Y_ul, ee, n
